...
//     console.log(numArrays[index])
//     for (let i = 0; i < numArrays[index].length; i++){
//         console.log(numArrays[index][i])
//         total = total + numArrays[index][i]
//     }  
// }
// console.log('Exercise 15 Result: ', total);

const printGreeting = (name) => {
  console.log(`Yo! ${name}. How's it going?`)
}
printGreeting("Katie")
...
console.log(reverseWordOrder("Hello my friends, I am reviewing"))
...
const letterReverse = (string) => {
  words = string.split('').reverse().join('').split(' ').reverse().join(' ')
  console.log(words)
}
